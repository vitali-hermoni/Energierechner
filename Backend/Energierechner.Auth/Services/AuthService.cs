...
namespace Energierechner.Auth.Services;
...
public class AuthService : IAuthService
{
    ...
    public async Task<ResponseDto> LoginAsync(LoginRequestDto loginRequestDto)
    {
        try
        {
            ...
            {
                return new ResponseDto(Message: ConstStrings.IsLockedOut);
            }
    ...
    public async Task<ResponseDto> RegisterAsync(RegisterRequestDto registerRequestDto)
    {
        try
        {
            ...
            try
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var responseDto = new ResponseDto(
                        Result: userResult,
                        Message: ConstStrings.RegisterUserOk,
                        IsSuccess: true);
            ...
            {
                _logger.LogError(ex, ex.Message);
                return new ResponseDto(Message: ConstStrings.RegisterUserError);
            }
        }
        catch (Exception ex)
        {
